...
\section{Addition}
  ...
  \subsection{Classic Ripple}
    ...
    \begin{figure}[ht]
        \capstart
        \centering
        \includegraphics[width=\textwidth]{images/classicalFA.tikz}
...
\subsection{Quantum Karatsuba}
  ...
  \subsection{Comparison of Multipliers}
    ...
    \subsubsection{Space Used}
      ...
      \begin{sidewaysfigure}[p]
        \capstart
        \includegraphics[width=\textwidth]{images/karaSize.tikz}
        \caption{Plot of bits used verses input size for various Karatsuba cutoffs}
        \label{fig:size}
      \end{sidewaysfigure}
      \begin{sidewaysfigure}[p]
        \capstart
        \includegraphics[width=\textwidth]{images/karaDepth.tikz}
