...
\section{Addition}
  ...
  \subsection{Classic Ripple}
    ...
    \todo{When an out of place adder is needed does this result in lower depth
    then the in place adder below? Possibly lower T-count as well since a full
    adder has T-count 7}
...
\subsection{Controlled Ripple}
    ...
    \subsection{Analysis}
      ...
      \todo{Discuss the carry lookahead adder here \cite{draper04}.}
...
\section{Multiplication}
  ...
  \subsection{Reversible Karatsuba\label{sec:kara}}
    ...
    splits\todo{define} instead of dividing the bit string in half at each
    ...
    the analysis.\todo{Maybe emphasize that this is the important part of the
    analysis.} 
    ...
    \subsubsection{Analysis}\todo{Maybe add an MDD for the circuit}
      ...
      gate, i.e., $K_1^{g}=1$.  We obtain the following recursion:\todo{Check
      these computations.}
...
\section{Division}
  \subsection{Binary integer division}
...
\section{Trigonometric functions}
    ...
    The CORDIC algorithm can be implemented reversibly.\todo{What is a
    reversible CORDIC useful for?}
...
This algorithm has been implemented and tested on the BLIF benchmarks. \todo{add reference and explain what BLIF is}
